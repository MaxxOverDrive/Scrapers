<?php
  ...
  $manufactNameTemp2 = "Morse Co";
  $manufactName2 = str_replace(' ', '%20', $manufactNameTemp2);
  $manufactNameTemp3 = "Valley Craft";
  $manufactName3 = str_replace(' ', '%20', $manufactNameTemp3);
  $manufactArray = array($manufactName1, $manufactName2, $manufactName3);
  $t = 0;
  ...
  for($m = 1; $m <= COUNT($manufactArray); $m++) {
    ...
    for($p = 1;$p < 5; $p++) {
      ...
      $url2 = "https://www.globalindustrial.com/searchResult?cp=.$p.&q=.$manufactName[$m]";
      $url3 = "https://www.sodyinc.com/index.php?main_page=advanced_search_result&search_in_description=1&keyword=.$manufactName[$m].&page=.$p";
      $url4 = "http://www.wrhardware.com/?subcats=Y&pcode_from_q=Y&pshort=Y&pfull=Y&pname=Y&pkeywords=Y&search_performed=Y&q=.$manufactName[$m].&dispatch=products.search";
